...
import be.kdg.hiFresh.domain.leverancier.*;
...
class TestData {
	...
	private void voegContractenToe(){
		contracten.add(new Contract(
			new Leverancier("Boer Koekoek", new ContactInfo(
				new Adres("Vorte Koestraat", "12", new Gemeente("9112", "Sinaai")), "bestel@koekoek.be",
				"+3237777645"),
				"BE0987333873"
				, 5),
			1,
		...
		contracten.add(new Contract(new Leverancier("Fred Willemssen", new ContactInfo(
			new Adres("Kettermuit", "1", new Gemeente("9100", "Sint-Niklaas")), "fred"
		...
		contracten.add(new Contract(new Leverancier("Filip Kruchten", new ContactInfo(
			new Adres("Boechoutdreef", "14", new Gemeente("2150", "Borsbeek")), "Filip007@hotmail"
			+ ".com",
			"+3235675656"),
	...
	private void maakProductContractPeriodes(
		Collection<Contract> contracten,
		Product prod,
		double prijs) {
